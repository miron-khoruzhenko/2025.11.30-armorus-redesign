    ...
    <section className="bg-[#1a1a1a] py-32 text-white">
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-start">
          ...
          <span className="text-lg font-bold font-display tracking-widest text-white mb-12 md:mb-0">
            Our Products
          </span>
          ...
          <div className="md:w-1/2 flex flex-col items-start md:mt-24">
            ...
            <h4 className="text-lg md:text-xl font-sans uppercase font-bold leading-relaxed mb-8 tracking-wide text-white">
            ...
            <p className="text-xs md:text-sm text-white font-light mb-16 leading-relaxed max-w-md">
             ...
             {/* Ссылка: Белая */}
             <Link href="/catalogue" className="text-[10px] font-bold uppercase tracking-widest border-b border-white pb-[1px] hover:opacity-80 transition text-white">
              View Catalogue
            </Link>
          </div>
