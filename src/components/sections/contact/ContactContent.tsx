...
export default function ContactContent() {
  return (
    <section className="py-24 bg-white text-black border-b border-black">
      <Container>
          ...
          <div className="lg:col-span-4 flex flex-col gap-12">
            ...
            <div>
              ...
              <p className="text-sm font-light font-sans leading-relaxed">
                Konutkent Mh. 3028. Sk. <br /> 
                SMK TOWER 23.Kat No:100 <br /> 
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-4 text-sm font-light font-sans">
                ...
                <div className="">
                  <a href="https://wa.me/+905327831498?text=I%20want%20to%20know%20more" target="_blank" rel="noopener noreferrer" className="">
                    <FaWhatsappSquare className="w-10 h-10 text-[#25D366]" />
                  </a>
                </div>
              </div>
            </div>
